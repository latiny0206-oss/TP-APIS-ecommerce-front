            ...
            <div className="flex items-center gap-1 lg:gap-2">
              ...
              {isLoggedIn ? (
                <div className="hidden sm:flex items-center gap-2">
                  <span className="font-mono text-[11px] tracking-widest-2 uppercase text-ivory/70">
                    {user?.nombre?.split(' ')[0]}
                  </span>
        ...
        <div className={`lg:hidden overflow-hidden border-t border-ivory/10 transition-[max-height] duration-500 ease-out ${mobileOpen ? 'max-h-[600px]' : 'max-h-0'}`}>
          <div className="bg-rock-800 px-6 py-6 flex flex-col gap-1">
            ...
            <div className="flex gap-2 mt-4">
              {isLoggedIn ? (
                <>
                  <span className="flex-1 flex items-center gap-2 px-3 py-3 border border-ivory/20 text-ivory/70 font-mono text-[10px] tracking-widest-2 uppercase">
