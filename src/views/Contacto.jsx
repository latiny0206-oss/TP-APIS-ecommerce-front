      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-10 lg:py-14">
        ...
        <div className="mb-12">
          ...
          <p className="text-rock/60 max-w-xl text-base lg:text-lg">
            ...
            Usá el formulario o contactanos directamente.
          </p>
        </div>
            ...
            {success ? (
              <div className="border-2 border-pine bg-pine/5 p-8 fadein">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="font-mono text-[11px] tracking-widest-2 uppercase text-pine">
                    Mensaje enviado
                  </span>
                </div>
            ...
            <div className="bg-rock text-ivory p-8 space-y-6">
              ...
              {CONTACT_INFO.map(({ Icon, label, value }) => (
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="font-mono text-[10px] tracking-widest-2 uppercase text-ivory/45 mb-1">
                      {label}
                    </div>
                    <div className="font-narrow font-semibold text-base text-ivory">
                      {value}
                    </div>
                  </div>
                </div>
