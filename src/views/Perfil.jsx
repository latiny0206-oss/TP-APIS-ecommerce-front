      ...
      <div className="max-w-[900px] mx-auto px-6 lg:px-10 py-10 lg:py-14">
        ...
        <section className="bg-rock text-ivory p-6 lg:p-8 mb-8">
          <div className="flex items-center gap-4 mb-1">
            ...
            <div>
              <p className="font-display font-black tracking-tightest uppercase text-2xl leading-tight">{user.nombre}</p>
                ...
                <div key={pedido.id} className="p-5 lg:p-6">
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <span className="font-mono font-bold text-[12px] tracking-widest-2 uppercase">{pedido.id}</span>
                  ...
                  <div className="flex justify-end border-t border-rock/10 pt-3">
                    ...
                    <span className="font-display font-black tracking-tightest text-lg uppercase">{fmtPrice(pedido.total)}</span>
                  </div>
                </div>
              ))}
            </div>
